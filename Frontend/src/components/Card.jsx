  ...
  return products?.map((product) => {
    return (
      <article
        ...
        <Link to={`/product/${product._id}`} className="block max-h-[540px]">
          ...
          <div className="p-4 flex flex-col gap-2">
            <p className="text-base md:text-lg font-semibold text-gray-800 group-hover:text-mullRed transition-colors duration-200 line-clamp-2">
              {product.name}
            </p>
